...
const UserSchema = new mongoose.Schema({
    ...
    // Registration OTP - same pattern as password reset
    registrationOtpHash: { type: String, default: null },
    ...
    pendingRegistration: { type: mongoose.Schema.Types.Mixed, default: null },
...
UserSchema.methods.toSafeJSON = function () {
    ...
    delete obj.registrationOtpHash;
    delete obj.registrationOtpExpires;
    delete obj.registrationOtpAttempts;
    delete obj.pendingRegistration;
    return obj;
};
