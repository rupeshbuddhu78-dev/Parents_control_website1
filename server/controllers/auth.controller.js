...
async function googleLogin(req, res) {
    try {
        ...
        const refreshTokenHash = RefreshToken.hashToken(refreshTokenValue);
...
module.exports = { register, login, refresh, logout, forgotPassword, resetPassword, verifyEmail, getMe, googleLogin, sendRegistrationOtp, verifyRegistrationOtp };
