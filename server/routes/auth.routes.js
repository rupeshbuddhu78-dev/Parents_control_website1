...
router.post('/auth/send-registration-otp', registerLimiter, ctrl.sendRegistrationOtp);
router.post('/auth/verify-registration-otp', registerLimiter, ctrl.verifyRegistrationOtp);
